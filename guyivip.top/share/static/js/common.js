...
async function requireAuth() {
  try {
    ...
    if (!location.pathname.endsWith('/login') && !location.pathname.endsWith(APP_BASE + '/login') && !location.pathname.endsWith('/login.html') && !location.pathname.endsWith(APP_BASE + '/login.html')) {
